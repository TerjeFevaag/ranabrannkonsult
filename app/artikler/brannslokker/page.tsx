...
export const metadata: Metadata = {
  title: 'Har du riktig brannslokkeapparat? | Rana Brannkonsult',
  description:
    'Hvilken type brannslokker trenger du? Vi gjennomgår krav til brannslokking i boliger, forskjellen mellom pulver og skum, og riktig bruk. Råd fra Rana Brannkonsult.',
